...
(meditations
  ...
  (= [95 96 97 98 99]
     ;; (drop 95 (range 100)))
     (filter (fn [x] (>= x 95)) (range 100)))

  "Iteration provides an infinite lazy sequence. Note: if you do a recursive
  function on your own that generates an infinite sequence, then you must use
  the lazy-seq"
